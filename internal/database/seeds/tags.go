...
func seedTags(ctx context.Context, client *ent.Client) error {
	err := client.Tag.CreateBulk(
		client.Tag.Create().SetID("1").SetName("Farbstoff").SetDescription("mit Farbstoff").SetShortName("🎨"),
		client.Tag.Create().SetID("2").SetName("Koffein").SetDescription("mit Koffein").SetShortName("☕"),
		...
		client.Tag.Create().SetID("Gf").SetName("Glutenfrei").SetDescription("Glutenfrei").SetPriority(schema.Medium).SetIsAllergy(true),
		client.Tag.Create().SetID("CO2").SetName("CO2-Neutral").SetDescription("CO2-Neutral").SetPriority(schema.Medium),
		client.Tag.Create().SetID("Bio").SetName("Bio").SetDescription("Bio").SetPriority(schema.Medium),
		client.Tag.Create().SetID("MV").SetName("MensaVital").SetDescription("MensaVital").SetPriority(schema.Medium),
		...
		client.Tag.Create().SetID("Kr").SetName("Krebstiere").SetDescription("Krebstiere").SetShortName("🦀").SetPriority(schema.Low).SetIsAllergy(true),
		...
		client.Tag.Create().SetID("Mi").SetName("Milch/Laktose").SetDescription("Milch/Laktose").SetShortName("🥛").SetPriority(schema.Medium).SetIsAllergy(true),
		client.Tag.Create().SetID("Man").SetName("Mandeln").SetDescription("Mandeln").SetPriority(schema.Low).SetIsAllergy(true),
		client.Tag.Create().SetID("Hs").SetName("Haselnüsse").SetDescription("Haselnüsse").SetShortName("🌰").SetPriority(schema.Low).SetIsAllergy(true),
